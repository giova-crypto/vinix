...
<div class="container center bg-secondary" style="padding-bottom: 10px; width: 40vw; margin-top: 5vh; margin-bottom: 5vh; border: 2px solid white; border-radius: 5px;">
    <form method="POST" action="{{ route('/pet/store') }}" class=" g-1 bg-secondary text-white">
        {{ csrf_field() }}
        <h1>Create Pet</h1>
        ...
        <div class="mb-3 form-group {{ $errors->has('name')?'has-error':'' }}">
            ...
            <input type="text" class="form-control" name="photoUrl" value={{ old('photoUrl') }}>
